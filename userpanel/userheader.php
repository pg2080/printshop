              ...
              <div class="site-top-icons">
                <ul>
                  ...
                  <?php
                    ...
                    {
                  ?>
                    <li><span style="font-family: fantasy; font-size: 14px;"><?php echo $_SESSION['emailid'];?></span><a href="customerdash.php"><span class="icon icon-person"></span></a></li>
                  ...
                  <?php 
                    ...
                    {
                  ?>
                  <li><span style="font-family: fantasy; font-size: 14px;"><?php echo $_SESSION['emailid'];?></span><a href="designerdash.php"><span class="icon icon-person"></span></a></li>
                    <?php }?>
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li><a href="./customerdash.php">My Profile</a></li>
            <?php
                }
                else
                {?>
            <li><a href="./designerdash.php">My Profile</a></li>
            <?php 
                }?>
